...
const keys = [
  ...
  'Add at least one available lunch option.', 'Spinning...', 'Spin Again', 'Recent', 'v1.2.455',
...
const values = {
  ko: [
    ...
    '선택 가능한 점심 메뉴를 하나 이상 추가하세요.', '돌리는 중...', '다시 돌리기', '최근 결과', 'v1.2.455',
  ...
  ja: [
    ...
    '利用可能なランチ候補を1つ以上追加してください。', '回転中...', 'もう一度回す', '最近の結果', 'v1.2.455',
  ...
  'zh-CN': [
    ...
    '请至少添加一个可用的午餐选项。', '转动中...', '再次转动', '最近结果', 'v1.2.455',
  ...
  es: [
    ...
    'Añade al menos una opción de almuerzo disponible.', 'Girando...', 'Girar de nuevo', 'Recientes', 'v1.2.455',
  ...
  de: [
    ...
    'Füge mindestens eine verfügbare Mittagessen-Option hinzu.', 'Wird gedreht...', 'Erneut drehen', 'Letzte Ergebnisse', 'v1.2.455',
  ...
  fr: [
    ...
    'Ajoutez au moins une option de déjeuner disponible.', 'Rotation...', 'Tourner à nouveau', 'Résultats récents', 'v1.2.455',
  ...
  'pt-BR': [
    ...
    'Adicione pelo menos uma opção de almoço disponível.', 'Girando...', 'Girar novamente', 'Recentes', 'v1.2.455',
